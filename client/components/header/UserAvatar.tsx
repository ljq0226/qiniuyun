  ...
  return (
    <>
      ...
      <div
        ...
        className="flex z-[30] px-4 absolute right-0 top-0 mt-[50px] bg-[var(--c-bg-b1)] flex-col w-[--w-header-useravatar] h-[--h-header-useravatar] border border-solid border-[var(--c-secondary-default)] rounded-2xl"
      >
